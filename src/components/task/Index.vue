  ...
  <div class="q-pa-xl q-gutter-y-md">
    ...
    <q-card>
      <q-card-section>
        <div class="text-h6">
          Tarea
        <q-btn @click="confirmCancel = true" round size="sm" color="primary" class="q-ml-sm float-right" icon="arrow_back">
          <q-tooltip>Salir</q-tooltip>
        </q-btn>
        <q-btn @click="$router.push('/Task/Create')" round size="sm" color="positive" class="q-ml-sm float-right btnCreate" icon="add">
