...
export const getDocumentCategories = (payload) => {
  const URL = `/api/admin/catalogs/get-document-categories/${payload}`
  return axiosInstance.get(URL).then((res) => res.data.cat_document_categories)
}
